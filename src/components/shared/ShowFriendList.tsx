  ...
  const handlefollow = async (
    ...
    try {
      if (!IsFriend) {
        ...
        async function addFriendsWithTimeout(
          newAddedFriendArray: any,
          newloggedInFriendArray: any,
          visitDocId: any,
          loginDocId: any
        ) {
          const targetAddFriendPromise = targetaddFriend(
            newAddedFriendArray,
            visitDocId
          );
          const loginAddFriendPromise = loginaddFriend(
            newloggedInFriendArray,
            loginDocId
          );
